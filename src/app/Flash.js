...
function DeviceState({ serial }) {
  return React.createElement(
    ...
    {
      className:
        "absolute bottom-0 m-0 lg:m-4 p-4 w-full sm:w-auto sm:min-w-[350px] sm:border sm:border-gray-200 dark:sm:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-md flex flex-row gap-2",
...
export default function Flash() {
  ...
  return React.createElement(
    "div",
    { id: "flash", className: "relative flex flex-col gap-8 justify-center items-center h-full" },
    React.createElement(
      "div",
      {
    ...
    (title === "Lost connection" || title === "Ready") &&
      isLinux &&
      React.createElement(
        React.Fragment,
        null,
        ...
        React.createElement(
          "div",
          { className: "relative mt-2 max-w-3xl" },
          React.createElement(
            "div",
            { className: "bg-gray-200 dark:bg-gray-800 rounded-md overflow-x-auto" },
            React.createElement(
              "div",
              { className: "relative" },
              React.createElement(
                ...
                {
                  className:
                    "font-mono text-sm text-gray-800 dark:text-gray-200 bg-gray-300 dark:bg-gray-700 rounded-md p-6 flex-grow max-w-m text-wrap",
                },

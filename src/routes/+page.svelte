...
<div class="flex flex-col lg:flex-row flex-wrap">
  ...
  >
    <section>
      ...
      <p>
        This tool allows you to flash AGNOS onto your comma device. AGNOS is the Ubuntu-based operating system for your
        <a
    ...
    <section>
      ...
      <ol>
        ...
        <li>
          First, connect the device to your computer using the <strong>lower</strong> <span class="whitespace-nowrap"
          >USB-C</span> port
          <strong>(port 1)</strong>.
        </li>
        <li>
          Second, connect power to the <strong>upper</strong>
          <span class="whitespace-nowrap">OBD-C</span>
          port <strong>(port 2)</strong>.
        </li>
      </ol>
      <img
        src={qdlPortsFour}
        alt="comma four and two ports. the right port is labeled 1. the left port is labeled 2."
        width={225}
        height={150}
      />
      <img
        src={qdlPortsThree}
        alt="comma three and two ports. the lower port is labeled 1. the upper port is labeled 2."
        width={450}
        height={300}
      />
      <p>
    ...
    <section>
      ...
      <p>
        This is normal in QDL mode. You can verify that the &ldquo;QUSB_BULK&rdquo; device shows up when you press the
